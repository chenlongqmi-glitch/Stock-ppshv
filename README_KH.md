...
|---|---|---|---|
| **SuperAdmin** | `superadmin` | `superadmin123` | **អភិបាលកំពូល:** មានសិទ្ធិពេញលេញលើប្រព័ន្ធទាំងមូល, គ្រប់គ្រង Admin, ប្រើមុខងារ **Switch User** (ចូលប្រើប្រាស់ជា User ណាម្នាក់ដោយគ្មានលេខសម្ងាត់) |
