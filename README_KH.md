...
|---|---|---|---|
| **Admin** | `admin` | `admin123` | មានសិទ្ធិពេញលេញ (កែប្រែ, លុប, អនុម័ត User, ការកំណត់) |
| **Stock Keeper** | `keeper` | `keeper123` | បញ្ចូលស្តុកចូល (Stock In), ដកស្តុកចេញ (Stock Out), ផ្ទេរ & កែតម្រូវ |

> 💡 **ចំណាំ:** បន្ទាប់ពី Login ចូល Admin លើកដំបូង អ្នកអាចបង្កើត User ថ្មី ឬប្តូរពាក្យសម្ងាត់បានតាមតម្រូវការ។
...
- ✅ **សុវត្ថិភាពខ្ពស់:** Password ត្រូវបានការពារដោយបច្ចេកវិទ្យា SHA-256 + Unique Salt។
- ✅ **គ្រប់គ្រងសិទ្ធិ (RBAC):** បែងចែករវាង Admin, Stock Keeper, និង Cashier។
