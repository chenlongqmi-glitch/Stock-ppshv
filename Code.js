...
function setupDatabase() {
  ...
  if (usersSheet.getLastRow() === 0) {
    ...
    const defaultWarehouses = [
      'ស្ថានីយ -1 K3 (ភ្នំពេញ)',
      'ស្ថានីយ -2 K26 (កំពង់ស្ពឺ កើត)',
      'ស្ថានីយ -3 K43 (កំពង់ស្ពឺ លិច)',
      'ស្ថានីយ -4 K76 (ត្រែងត្រយឹង)',
      'ស្ថានីយ -5 K114 (កំពង់សីលា)',
      'ស្ថានីយ -6 K135 (ស្រែអំបិល)',
      'ស្ថានីយ -7 K172 (ស្ទឹងហាវ)',
      'ស្ថានីយ -8 K182 (ព្រះសីហនុ)',
  ...
  if (whSheet.getLastRow() === 0) {
    ...
    whSheet.appendRow(['WH-01', 'ស្ថានីយ -1 K3 (ភ្នំពេញ)', 'ភ្នំពេញ', 'លោក សុខា', 'Active']);
    whSheet.appendRow(['WH-02', 'ស្ថានីយ -2 K26 (កំពង់ស្ពឺ កើត)', 'កំពង់ស្ពឺ កើត', 'កញ្ញា រតនា', 'Active']);
    whSheet.appendRow(['WH-03', 'ស្ថានីយ -3 K43 (កំពង់ស្ពឺ លិច)', 'កំពង់ស្ពឺ លិច', 'លោក ចាន់ណា', 'Active']);
    whSheet.appendRow(['WH-04', 'ស្ថានីយ -4 K76 (ត្រែងត្រយឹង)', 'ត្រែងត្រយឹង', 'លោក វិបុល', 'Active']);
    whSheet.appendRow(['WH-05', 'ស្ថានីយ -5 K114 (កំពង់សីលា)', 'កំពង់សីលា', 'អ្នកស្រី ធីតា', 'Active']);
    whSheet.appendRow(['WH-06', 'ស្ថានីយ -6 K135 (ស្រែអំបិល)', 'ស្រែអំបិល', 'លោក សម្បត្តិ', 'Active']);
    whSheet.appendRow(['WH-07', 'ស្ថានីយ -7 K172 (ស្ទឹងហាវ)', 'ស្ទឹងហាវ', 'កញ្ញា ម៉ាលី', 'Active']);
    whSheet.appendRow(['WH-08', 'ស្ថានីយ -8 K182 (ព្រះសីហនុ)', 'ព្រះសីហនុ', 'លោក ពិសិដ្ឋ', 'Active']);
